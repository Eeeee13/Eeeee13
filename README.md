...
Меня зовут **Новокещенов Егор**, я студент университета иннополис, ML инженер & разработчик ПО. 

Быстро учусь, ответственный, умею делегировать и работать в команде, эффективно использовать AI.
...
[**дипломы**](https://disk.yandex.ru/d/bo-_UyQxsvukJQ)
...
- **RAG-система для юридической сферы** - сервис для ускорения работы Юристов. RAG поиск по открытым базам с делами. RAG поиск по личной базе данных. (3 месяца)
  - стэк:
    + Python
    + langchain
    + Llama
...
## Пет-проекты:
- **Reinforcement Learning Гонщик** - учебный проект, кастомное окружение с агентом-гонщиком. наглядно показывается как агент приспосабливается к управлению на трассе.(2 месяца)
  - Стэк:
    + Python
    + pyGames
    + Stable-Baselines3
...
## учебные проекты:
- **A_Star и backtracking алгоритмы визуализация** - проект в рамках AI курса. Алгорим генерирует карту и запускает тестировщик одного из двух алгоритмов. все визуализируется в отдельном окне.(2 недели)
  - Стэк:
    + Python
    + Pygames
  -  Моя зона ответственности:
...
- Telegram: @Novokreshchenov_E 

---

## хобби
- Делаю инди игры на юнити.
- Много спорта: футбол, сноубординг, единоборства.
